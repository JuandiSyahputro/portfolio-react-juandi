...
export const AnimatedBorderButton = ({ children, className = "", ...props }) => {
  return (
    <button
      ...
      {...props}>
      {/* Animated SVG Border */}
      <svg className="absolute left-0 top-0 w-full h-full pointer-events-none download-cv-border" viewBox="0 0 200 60" preserveAspectRatio="none" style={{ overflow: "visible" }}>
        <path

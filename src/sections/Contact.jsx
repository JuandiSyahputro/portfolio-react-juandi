...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "syahputroj@gmail.com",
    href: "mailto:syahputroj@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+62 813-1569-8503",
    href: "tel:+6281315698503",
  },
  {
    icon: MapPin,
    label: "Location",
...
export const Contact = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        templateId,
        {
          title: " From Personal Portfolio Juandi",
          name: formData.name,
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden" {...props}>
